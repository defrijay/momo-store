    ...
    <footer class="bg-gray-800">
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-start lg:gap-8">
          ...
          <div class="mt-8 grid grid-cols-4 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form class="w-full">
                <div class="mb-4">
                    <h1 class="text-lg font-bold">SUBSCRIBE TO OUR NEWSLETTER</h1>
                    <h1 class="text-sm">A short sentence describing what someone will receive by subscribing</h1>
                </div>
                <label for="UserEmail" class="sr-only text-white"> Email </label>
    
                <div
                  class="border border-gray-600 rounded-lg p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
                >
                  <input
                    type="email"
                    id="UserEmail"
                    placeholder="john@rhcp.com"
                    class="w-full rounded-lg border-none focus:border-transparent focus:ring-transparent sm:text-sm text-black"
                  />
    
                  <button
                    class="mt-1 w-full rounded-lg bg-teal-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    Subscribe
                  </button>
                </div>
            ...
            <div class="col-span-2 sm:col-span-1">
              ...
              <ul class="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> Accessibility </a>
                </li>
    
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> Returns Policy </a>
                </li>
    
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> Refund Policy </a>
                </li>
    
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> Hiring Statistics </a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-span-2 sm:col-span-1">
              ...
              <ul class="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> Marketing Calendar </a>
                </li>
    
                <li>
                  <a href="#" class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"> SEO Infographics </a>
                </li>
              </ul>
            </div>
            ...
            <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-gray-700 dark:text-gray-300 transition hover:opacity-75"
                >
