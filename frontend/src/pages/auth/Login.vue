      ...
      <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        ...
        <div class="hidden lg:relative lg:block lg:p-12">
          ...
          <p class="mt-4 leading-relaxed text-white/90">
            Sebelum belanja masuk akunmu dulu yuk!
          </p>
        </div>
      </section>
      ...
      <main class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
        <div class="max-w-xl lg:max-w-3xl">
          <div class="relative -mt-16 block lg:hidden">
            <a class="inline-flex size-16 items-center justify-center rounded-full bg-white text-teal-600 sm:size-20 dark:bg-gray-900"
              href="#">
              <span class="sr-only">Home</span>
              <svg class="h-8 sm:h-10" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <h1 class="mt-2 text-2xl font-bold sm:text-3xl md:text-4xl text-white">
              Selamat datang di Akun Momo Mart
            </h1>

            <p class="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
              Sebelum belanja masuk akunmu dulu yu!
            </p>
          </div>
          ...
          <form @submit.prevent="loginUser" class="mt-8 grid grid-cols-6 gap-6">
            <div class="col-span-12">
              ...
              <input v-model="email" type="email" id="email"
                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm  shadow-sm dark:border-gray-700 dark:bg-gray-800 text-gray-600"
                required />
            </div>
