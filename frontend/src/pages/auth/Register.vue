      ...
      <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        ...
        <div class="hidden lg:relative lg:block lg:p-12">
          ...
          <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
            Welcome to MOMO Mart
          </h2>

          <p class="mt-4 leading-relaxed text-white/90">
            Sebelum belanja daftar akunmu dulu yuk!
          </p>
        </div>
      </section>
        ...
        <div class="max-w-xl lg:max-w-3xl">
          <div class="relative -mt-16 block lg:hidden">
            ...
            <h1 class="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl dark:text-white">
              Selamat datang di Akun Momo Mart
            </h1>

            <p class="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
              Sebelum belanja daftar akunmu dulu yu!
            </p>
          </div>
          ...
          <form @submit.prevent="registerUser" class="mt-8 grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-span-12">
              ...
              <input v-model="formData.password_confirmation" type="password" id="PasswordConfirmation"
                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                required />
            </div>
            ...
            <div class="col-span-6">
              <label for="MarketingAccept" class="flex gap-4">
                <input type="checkbox" id="MarketingAccept" name="marketing_accept"
                  class="size-5 rounded-md border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-offset-gray-900" required/>

                <span class="text-sm text-gray-700 dark:text-gray-200">
                  Saya sudah mengisi data saya dengan benar
                </span>
              </label>
            </div>

            <div class="col-span-6">
              <button type="submit" class="mt-4 w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800":disabled="loading"> {{ loading ? "Mendaftarkan..." : "Daftar" }}
              </button>
            </div>
          </form>
